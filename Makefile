...
pages_url    := https://the-ai-alliance.github.io/open-trusted-model-initiative/
docs_dir     := docs
...
2024-12-13 11:00 -0600           ?= $(shell date +"%Y%m%d-%H%M%S")
...
print-info:
	...
	@echo "2024-12-13 11:00 -0600:           ${2024-12-13 11:00 -0600}"
...
# `localhost:4000/The-AI-Alliance/open-trusted-model-initiative` when running locally.
run-jekyll: clean 
	@echo
