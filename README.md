...
[Published Documentation](https://the-ai-alliance.github.io/open-trusted-model-initiative/)

This repo contains the code and documentation for the AI Alliance: "_Open Trusted Model Initiative_".

See the [repo README](https://the-ai-alliance.github.io/open-trusted-model-initiative/) for additional details about this project.
